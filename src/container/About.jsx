...
const About = () => {
  return (
    <Zoom triggerOnce>
      <section className="mt-28 lg:mt-40 flex flex-col lg:flex-row justify-between items-top lg:px-18 gap-5">
        <article className="lg:mr-20 lg:w-2/3">
          <h1 className="font-bold text-secondary text-4xl sm:text-6xl leading-12 ">
            About Me
          </h1>

          <article className="text-lightest-slate flex flex-col mt-10 gap-6 text-xs sm:text-base leading-7 sm:leading-8">
