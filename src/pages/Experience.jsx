  ...
  return (
    <section className = "bg-navy h-full w-full px-6 py-20 sm:py-14 sm:px-10 md:px-28 lg:px-36 xl:px-44 text-focus-in">
        ...
        <div className = "flex flex-col gap-20 lg:mt-10">
            ...
            <div>
                <h1 className = "font-bold text-secondary text-4xl sm:text-6xl leading-12">Where I've Worked</h1>
                <hr className = "mt-6"/>
            </div>
                ...
                <div className = "flex md:gap-20 gap-5">
                    ...
                    <div className = "flex flex-col gap-10">
                        ...
                        <div className = "flex flex-col gap-2">
                            <h1 className = "text-lightest-slate text-xl">{title}<span className = "text-primary"> @ {company}</span></h1>
                            <p className = "text-primary font-light">{start} - {finish}</p>
                        </div>
